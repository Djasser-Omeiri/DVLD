...
namespace DVLD {
    ...
    public partial class DVLDDataSet1 : global::System.Data.DataSet {
        ...
        public partial class PeopleDataTable : global::System.Data.TypedTableBase<PeopleRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public PeopleRow AddPeopleRow(string NationalNo, string FirstName, string SecondName, string ThirdName, string LastName, System.DateTime DateOfBirth, byte Gendor, string Address, string Phone, string Email, string ImagePath) {
...
namespace DVLD.DVLDDataSet1TableAdapters {
    ...
    public partial class CountriesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT CountryName FROM dbo.Countries";
        ...
        public virtual int Fill(DVLDDataSet1.CountriesDataTable dataTable) {
        ...
        public virtual DVLDDataSet1.CountriesDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DVLDDataSet1.CountriesDataTable dataTable = new DVLDDataSet1.CountriesDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DVLDDataSet1.CountriesDataTable dataTable) {
    ...
    public partial class PeopleTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[People] SET [NationalNo] = @NationalNo, [FirstName] = @FirstName, [SecondName] = @SecondName, [ThirdName] = @ThirdName, [LastName] = @LastName, [DateOfBirth] = @DateOfBirth, [Gendor] = @Gendor, [Address] = @Address, [Phone] = @Phone, [Email] = @Email, [ImagePath] = @ImagePath WHERE (([PersonID] = @Original_PersonID) AND ([NationalNo] = @Original_NationalNo) AND ([FirstName] = @Original_FirstName) AND ([SecondName] = @Original_SecondName) AND ((@IsNull_ThirdName = 1 AND [ThirdName] IS NULL) OR ([ThirdName] = @Original_ThirdName)) AND ([LastName] = @Original_LastName) AND ([DateOfBirth] = @Original_DateOfBirth) AND ([Gendor] = @Original_Gendor) AND ([Address] = @Original_Address) AND ([Phone] = @Original_Phone) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)) AND ((@IsNull_ImagePath = 1 AND [ImagePath] IS NULL) OR ([ImagePath] = @Original_ImagePath)));
SELECT PersonID, NationalNo, FirstName, SecondName, ThirdName, LastName, DateOfBirth, Gendor, Address, Phone, Email, ImagePath FROM People WHERE (PersonID = @PersonID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT PersonID, NationalNo, FirstName, SecondName, ThirdName, LastName, DateOfBi" +
                "rth, Gendor, Address, Phone, Email, ImagePath FROM dbo.People";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        public virtual int Update(
            ...
            if ((Original_NationalNo == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[12].Value = ((string)(Original_NationalNo));
            }
            if ((Original_FirstName == null)) {
                throw new global::System.ArgumentNullException("Original_FirstName");
            }
            ...
            if ((Original_ThirdName == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[16].Value = ((string)(Original_ThirdName));
            }
            if ((Original_LastName == null)) {
                throw new global::System.ArgumentNullException("Original_LastName");
            }
            ...
            this.Adapter.UpdateCommand.Parameters[19].Value = ((byte)(Original_Gendor));
            if ((Original_Address == null)) {
                throw new global::System.ArgumentNullException("Original_Address");
            }
            else {
            ...
            if ((Original_ImagePath == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[25].Value = ((string)(Original_ImagePath));
            }
        ...
        public virtual int Update(
                    ...
                    string Original_Email, 
                    string Original_ImagePath) {
            return this.Update(NationalNo, FirstName, SecondName, ThirdName, LastName, DateOfBirth, Gendor, Address, Phone, Email, ImagePath, Original_PersonID, Original_NationalNo, Original_FirstName, Original_SecondName, Original_ThirdName, Original_LastName, Original_DateOfBirth, Original_Gendor, Original_Address, Original_Phone, Original_Email, Original_ImagePath, Original_PersonID);
        }
    }
